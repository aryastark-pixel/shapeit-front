...
const testimonials: Testimonial[] = [
  {
    ...
    image: 'rev1.jpg',
    quote: 'Shape IT perfectly captured our vision and turned it into a stunning, user-friendly website. Super impressed with their creativity and professionalism!',
    rating: 5
  },
  {
    id: '2',
  ...
  },
  {
    ...
    company: 'India',
    image: 'dbms.png',
    quote: 'The team perfectly captured our requirements for a local DBMS. Impressed with the efficency of the team!',
    rating: 5
  },
            ...
            <div className="relative z-10 p-8 md:p-12">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="w-full md:w-2/3">
                  <svg className="h-12 w-12 text-gray-200 mb-6" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
