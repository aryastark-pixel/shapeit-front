...
const teamMembers: TeamMember[] = [
  ...
  //   id: '4',
  //   name: 'Abrar',
  //   role: 'FullStack and AI',
  //   image: 'abrar.jpg',
  //   bio: 'AI and Full Stack Developer, specializing in building innovative solutions and seamless web applications, driving technology and business growth within the company.',
  //   social: {
  //     // github: '#',
  //     linkedin: 'https://www.linkedin.com/in/abrar-sayyed/',
  //     email: 'sayyedabrar051@gmail.com'
  //   }
  // }
];
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 to-transparent opacity-0 group-hover:opacity-80 transition-opacity duration-300 flex items-end justify-center">
                  <div className="pb-6 flex gap-4">
                    {member.social.twitter && (
                      <a href={member.social.twitter} target="_blank" className="bg-white/20 p-2 rounded-full hover:bg-white/40 transition-colors">
                        <Twitter className="h-5 w-5 text-white" />
                      </a>
                    )}
                    {member.social.linkedin && (
                      <a href={member.social.linkedin}target="_blank" className="bg-white/20 p-2 rounded-full hover:bg-white/40 transition-colors">
                        <Linkedin className="h-5 w-5 text-white" />
                      </a>
                    )}
                    {member.social.github && (
                      <a href={member.social.github} target="_blank" className="bg-white/20 p-2 rounded-full hover:bg-white/40 transition-colors">
